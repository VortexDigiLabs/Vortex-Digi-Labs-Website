...
=======
    <motion.div
      ...
      initial="hidden"
      animate="visible"
      className="flex min-h-[500px] flex-col items-center justify-center px-4 py-16 text-center bg-charcoal text-silver"
    >
      <motion.div variants={itemVariants} className="mb-4">
        <a href="#hero" className="inline-flex items-center gap-2 rounded-full border border-cyan/50 bg-cyan/10 px-4 py-1.5 text-sm font-medium text-cyan transition-all duration-300 hover:bg-cyan/20 hover:shadow-[0_0_15px_rgba(0,255,255,0.5)] cursor-pointer">
      ...
      <motion.p
        variants={itemVariants}
        className="mb-8 max-w-2xl text-lg text-silver/70"
      >
        Create stunning, animated interfaces with our collection of
        production-ready components. Built with React, Framer Motion, and
        TailwindCSS.
      ...
      <motion.div
        variants={itemVariants}
        className="mt-12 flex items-center gap-8 text-sm text-silver/60"
      >
        <div>
          <div className="text-2xl font-bold text-white">
            10k+
